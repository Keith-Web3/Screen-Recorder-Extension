"use strict";
(self["webpackChunkscreen_recorder_extension"] = self["webpackChunkscreen_recorder_extension"] || []).push([["src_assets_tailwind_css"],{
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Work+Sans:wght@400;500;600&display=swap);"]);
// Module
...
.border-\\[\\#100A42\\] {
  --tw-border-opacity: 1;
  border-color: rgb(16 10 66 / var(--tw-border-opacity));
}
.border-\\[\\#BEBEBE\\] {
  --tw-border-opacity: 1;
...
.bg-\\[\\#120B48\\] {
  --tw-bg-opacity: 1;
  background-color: rgb(18 11 72 / var(--tw-bg-opacity));
}
.bg-\\[\\#141414\\] {
  --tw-bg-opacity: 1;
...
.bg-\\[\\#928FAB\\] {
  --tw-bg-opacity: 1;
  background-color: rgb(146 143 171 / var(--tw-bg-opacity));
}
.bg-\\[\\#C00404\\] {
  --tw-bg-opacity: 1;
  background-color: rgb(192 4 4 / var(--tw-bg-opacity));
}
.bg-\\[\\#E8E8E8\\] {
  --tw-bg-opacity: 1;
...
.text-\\[\\#100A42\\] {
  --tw-text-opacity: 1;
  color: rgb(16 10 66 / var(--tw-text-opacity));
}
.text-\\[\\#120B48\\] {
  --tw-text-opacity: 1;
  color: rgb(18 11 72 / var(--tw-text-opacity));
}
.text-\\[\\#413C6D\\] {
  --tw-text-opacity: 1;
  color: rgb(65 60 109 / var(--tw-text-opacity));
}
.text-\\[\\#928FAB\\] {
  --tw-text-opacity: 1;
  color: rgb(146 143 171 / var(--tw-text-opacity));
}
.text-white {
  --tw-text-opacity: 1;
  color: rgb(255 255 255 / var(--tw-text-opacity));
}
.shadow-\\[0px_0px_4px_4px_\\#c0040430\\] {
  --tw-shadow: 0px 0px 4px 4px #c0040430;
